...
const utils_1 = __nccwpck_require__(872);
/**
 * Commands
 *
 * Command Format:
...
const file_command_1 = __nccwpck_require__(118);
const utils_1 = __nccwpck_require__(872);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(768);
/**
...
const http_client_1 = __nccwpck_require__(287);
const auth_1 = __nccwpck_require__(161);
const core_1 = __nccwpck_require__(423);
class OidcClient {
...
const pm = __nccwpck_require__(238);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(518);
            }
            const agentOptions = {
...
let Mime = __nccwpck_require__(475);
module.exports = new Mime(__nccwpck_require__(56), __nccwpck_require__(175));
...
module.exports = __nccwpck_require__(11);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.configCciAuth = void 0;
const core = __importStar(__nccwpck_require__(423));
const context = __importStar(__nccwpck_require__(606));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.replaceMatchingFileContent = exports.updateImage = void 0;
const core = __importStar(__nccwpck_require__(423));
const fs = __importStar(__nccwpck_require__(147));
const path = __importStar(__nccwpck_require__(17));
/*
...
function replaceMatchingFileContent(imageArray, manifestPath) {
    return __awaiter(this, void 0, void 0, function* () {
        /*
...
exports.replaceMatchingFileContent = replaceMatchingFileContent;
...
function installCciIamAuthenticator(downloadURL) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (cp.execSync(`curl -LO "${downloadURL}"   && chmod +x ./cci-iam-authenticator && mv ./cci-iam-authenticator /usr/local/bin`) || '').toString();
...
exports.run = void 0;
const core = __importStar(__nccwpck_require__(423));
const utils = __importStar(__nccwpck_require__(363));
const context = __importStar(__nccwpck_require__(606));
const install = __importStar(__nccwpck_require__(866));
const auth = __importStar(__nccwpck_require__(380));
const image = __importStar(__nccwpck_require__(701));
const deploy = __importStar(__nccwpck_require__(698));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const inputs = context.getInputs();
        //如果参数输入有问题，终止操作
...
const fs = __importStar(__nccwpck_require__(147));
const path = __importStar(__nccwpck_require__(17));
const mime = __importStar(__nccwpck_require__(251));
/**
